...
def international_header(request):
    ...
    is_bgs_site = True if 'business' in request.build_absolute_uri().split('/')[2] else False
    international_base_url = settings.BGS_INTERNATIONAL_URL if is_bgs_site else settings.GREAT_INTERNATIONAL_URL
