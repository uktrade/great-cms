# Generated by Django 4.1.13 on 2024-02-09 13:35
...
import core.mixins
import international.cms_panels
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='GreatInternationalHomePage',
            fields=[
                (
                    'page_ptr',
                ...
                ('dep_title', models.TextField(blank=True, null=True)),
                ('dep_sub_title', models.TextField(blank=True, null=True)),
                (
                    'dep_cards',
                    wagtail.fields.StreamField(
                        [
