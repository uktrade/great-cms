    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_text_signedin', models.TextField(blank=True, null=True)),
                ('hero_subtitle_signedin', models.TextField(blank=True, null=True)),
                ('hero_cta_text_signedin', models.CharField(blank=True, max_length=255, null=True)),
                ('hero_cta_url_signedin', models.CharField(blank=True, max_length=255, null=True)),
                ('magna_ctas_title', models.TextField(blank=True, null=True)),
                (
                    'magna_ctas_columns',
                    wagtail.core.fields.StreamField(
                        [
            ...
            bases=(
                export_academy.cms_panels.ExportAcademyPagePanels,
                'wagtailcore.page',
            ),
        ),
    ]
