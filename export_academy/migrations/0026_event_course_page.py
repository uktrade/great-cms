# Generated by Django 4.1.10 on 2023-09-27 12:19
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('core', '0114_alter_micrositepage_cta_teaser_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_heading', models.TextField(blank=True, max_length=255, null=True)),
                ('summary', models.TextField(blank=True, max_length=255, null=True)),
                ('is_course_right_for_you_heading', models.TextField(blank=True, max_length=255, null=True)),
                (
                    'is_course_right_for_you_list',
                    wagtail.fields.StreamField(
                        [
                            (
                                'is_course_right_for_you_list',
                ...
                ('benefits_heading', models.TextField(blank=True, max_length=255, null=True)),
                (
                    'benefits_list',
                    wagtail.fields.StreamField(
                        [
                ...
                ('course_content_heading', models.TextField(blank=True, max_length=255, null=True)),
                ('course_content_desc', models.TextField(blank=True, max_length=255, null=True)),
                ('speakers', wagtail.fields.RichTextField(blank=True, null=True)),
                (
                    'hero_image',
                    models.ForeignKey(
                        blank=True,
            ...
            bases=(
                export_academy.cms_panels.CoursePagePanels,
                'wagtailcore.page',
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, export_academy.cms_panels.EventsInCoursePanel),
        ),
        migrations.CreateModel(
            name='ModuleEventSet',
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        ...
                        to='export_academy.eventsoncourse',
                    ),
                ),
            ],
        ),
