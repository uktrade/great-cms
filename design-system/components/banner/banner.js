export class GreatBanner extends HTMLElement {
  constructor() {
    super()

    const template = document.getElementById('great-banner-template')
...
if (!customElements.get('great-banner')) customElements.define('great-banner', GreatBanner);
