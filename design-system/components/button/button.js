...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
      ...
      const availableSizes = ['large']

      switch (name) {
        case 'size':
          if (availableSizes.includes(newValue)) {
    ...
    connectedCallback() {
      ...
      const { class: className, icon, loading, style, theme, size, ...rest } = convertAttributesToObject({ self: this })
