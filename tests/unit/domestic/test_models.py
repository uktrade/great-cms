...
class TopicLandingPageTests(WagtailPageTests):
    def test_allowed_parents(self):
        self.assertAllowedParentPageTypes(TopicLandingPage, {DomesticHomePage})
    ...
    def test_slug_is_autogenerated(self):
        ...
        advice_topic_page = TopicLandingPage(
            title='Advice',
            template=TopicLandingPage.template_choices[0][0],
        )
        ...
        markets_topic_page = TopicLandingPage(
            title='Markets',
            template=TopicLandingPage.template_choices[1][0],
        )
