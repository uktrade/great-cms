...
def test_estimated_read_time_calculation__checks_video(rf, domestic_homepage):
    ...
    expected_duration = timedelta(seconds=78 + 100)  # reading + watching
...
def test_estimated_read_time_calculation__updates_only_draft_if_appropriate(rf, domestic_homepage):
    ...
    expected_duration = timedelta(seconds=53)  # NB just the read time of a skeleton DetailPage
    ...
    assert detail_page.estimated_read_duration == timedelta(seconds=53)
