...
@pytest.fixture
def topics_with_lessons_and_placeholders(domestic_site_browser_tests):
    ...
    # ]
    topic_a.save()
    topic_a = add_lessons_and_placeholders_to_curated_list_page(
        curated_list_page=topic_a,
        data_for_topics={
            0: {
                'id': '495856f0-37ae-496b-a7c4-cd010a6e7011',
                'title': 'Some title',
    ...
    # ]
    topic_b.save()
    topic_b = add_lessons_and_placeholders_to_curated_list_page(
        curated_list_page=topic_b,
        data_for_topics={
            0: {
                'id': '395856f0-37ae-496b-a7c4-cd010a6e7011',
                'title': 'Some title',
