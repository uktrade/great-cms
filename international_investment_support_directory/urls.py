...
urlpatterns = [
    ...
    path(
        'find-a-specialist/specialist/<slug:company_number>/',
        views.FindASpecialistProfileView.as_view(),
        name='specialist-profile',
    ),
    path(
        'find-a-specialist/specialist/case-study/<slug:case_study_id>/',
        views.FindASpecialistCaseStudyView.as_view(),
        name='specialist-case-study',
    ),
    path(
        'find-a-specialist/specialist/<slug:company_number>/contact/',
