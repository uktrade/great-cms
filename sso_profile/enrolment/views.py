...
import sso_profile.core.forms
import sso_profile.core.mixins
from directory_constants import urls, user_roles
from sso_profile.core.helpers import get_company_admins
from sso_profile.enrolment import constants, forms, helpers, mixins

URL_NON_COMPANIES_HOUSE_ENROLMENT = reverse_lazy(
    'sso_profile:enrolment-sole-trader', kwargs={'step': constants.USER_ACCOUNT}
)
URL_COMPANIES_HOUSE_ENROLMENT = reverse_lazy(
    'sso_profile:enrolment-companies-house', kwargs={'step': constants.USER_ACCOUNT}
)
URL_INDIVIDUAL_ENROLMENT = reverse_lazy('sso_profile:enrolment-individual', kwargs={'step': constants.USER_ACCOUNT})
URL_OVERSEAS_BUSINESS_ENROLMNET = reverse_lazy('sso_profile:enrolment-overseas-business')
...
class BaseEnrolmentWizardView(
    ...
    sso_profile.core.mixins.PreventCaptchaRevalidationMixin,
    sso_profile.core.mixins.CreateUpdateUserProfileMixin,
...
class CompaniesHouseEnrolmentView(mixins.CreateBusinessProfileMixin, BaseEnrolmentWizardView):
    ...
    form_list = (
        ...
        (constants.PERSONAL_INFO, sso_profile.core.forms.PersonalDetails),
    )
        ...
        if helpers.get_is_enrolled(data['company_number']):
            ...
            helpers.notify_company_admins_member_joined(
                ...
                data={
                    ...
                    'profile_remove_member_url': (self.request.build_absolute_uri(reverse('sso_profile:-admin-tools'))),
