...
class PersonalDetailsFormView(sso_profile.core.mixins.CreateUpdateUserProfileMixin, SuccessMessageMixin, FormView):
    template_name = 'business_profile/personal-details-form.html'
    form_class = sso_profile.core.forms.PersonalDetails
    success_url = reverse_lazy('business-profile')
