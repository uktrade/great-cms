...
class TestFormSubmission(TestCase):
    ...
    def test_post_valid_form(self):
        ...
        self.assertTrue(FormSubmission.objects.filter(page=form_page, form_data__your_message="hello world").exists())
    ...
    def test_post_multiple_values(self):
        ...
        form_page = Page.objects.get(url_path="/home/contact-us/")
        submission = FormSubmission.objects.filter(page=form_page, form_data__your_message="hello world")
...
class TestFormWithCustomSubmission(TestCase, WagtailTestUtils):
    ...
    def test_post_valid_form(self):
        ...
        form_page = Page.objects.get(url_path="/home/contact-us/")
        self.assertTrue(
            CustomFormPageSubmission.objects.filter(page=form_page, form_data__your_message="hello world").exists()
        )
    ...
    def test_post_form_twice(self):
        ...
        self.assertTrue(submissions_qs.filter(form_data__your_message="hello world").exists())
    ...
    def test_post_multiple_values(self):
        ...
        # Check that the three checkbox values were saved correctly
        form_page = Page.objects.get(url_path="/home/contact-us/")
        submission = CustomFormPageSubmission.objects.filter(page=form_page, form_data__your_message="hello world")
...
class TestFormSubmissionWithMultipleRecipientsAndWithCustomSubmission(TestCase, WagtailTestUtils):
    def setUp(self):
        # Create a form page
        self.form_page = make_form_page_with_custom_submission(to_address="to@email.com, another@email.com")
...
class TestIssue798(TestCase, WagtailTestUtils):
    ...
    def test_post(self):
        ...
        # Check that form submission was saved correctly
        self.assertTrue(
            FormSubmission.objects.filter(page=self.form_page, form_data__your_message="hello world").exists()
        )
        self.assertTrue(
            FormSubmission.objects.filter(page=self.form_page, form_data__your_favourite_number="7.3").exists()
        )
