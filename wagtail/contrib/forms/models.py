...
class AbstractFormField(Orderable):
    ...
    choices = models.TextField(
        ...
        blank=True,
        help_text=_("Comma or new line separated list of choices. Only applicable in checkboxes, radio and dropdown."),
    )
    default_value = models.TextField(
        verbose_name=_("default value"),
        blank=True,
        help_text=_("Default value. Comma or new line separated values supported for checkboxes."),
    )
...
class EmailFormMixin(models.Model):
    ...
    from_address = models.EmailField(verbose_name=_("from address"), max_length=255, blank=True)
