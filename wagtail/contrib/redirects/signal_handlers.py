...
def autocreate_redirects_on_slug_change(instance_before: Page, instance: Page, **kwargs):
    ...
    sites = Site.objects.filter(
        id__in=[option.site_id for option in instance._get_relevant_site_root_paths(cache_object=instance)]
...
def autocreate_redirects_on_page_move(
    ...
    **kwargs,
    ...
    new_site_ids = {item.site_id for item in instance._get_relevant_site_root_paths(cache_object=instance)}
