...
class TestRedirects(TestCase):
    ...
    def test_path_normalisation(self):
        ...
        self.assertEqual(
            path,
            normalise_path("/Hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # The exact same URL
        )
        self.assertEqual(
            path,
        ...
        self.assertEqual(
            path,
            normalise_path("Hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # Leading slash can be omitted
        )
        self.assertEqual(
            path,
            normalise_path("Hello/world.html/;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # Trailing slashes are ignored
        )
        self.assertEqual(
            path,
            normalise_path("/Hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2#cool"),  # Fragments are ignored
        )
        self.assertEqual(
            path,
        ...
        self.assertEqual(
            path,
            normalise_path("  /Hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # Leading whitespace
        )
        self.assertEqual(
            path,
            normalise_path("/Hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2  "),  # Trailing whitespace
        )

        # Test against different paths
        self.assertNotEqual(
            path,
            normalise_path("/hello/world.html;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # 'hello' is lowercase
        )
        self.assertNotEqual(
            path,
            normalise_path("/Hello/world;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # No '.html'
        )
        self.assertNotEqual(
            path,
        ...
        self.assertNotEqual(
            path,
            normalise_path("/Hello/world.html;Fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # Parameter name has wrong case
        )
        self.assertNotEqual(
            path,
        ...
        self.assertNotEqual(
            path,
            normalise_path("/Hello/WORLD.html;fizz=three;buzz=five?foo=Bar&Baz=quux2"),  # 'WORLD' is uppercase
        )
        self.assertNotEqual(
            path,
