...
class PermissionHelper:
    ...
    def all_permission_codenames(self):
        return list(self.get_all_model_permissions().values_list("codename", flat=True).distinct())
...
class PagePermissionHelper(PermissionHelper):
    ...
    def get_valid_parent_pages(self, user):
        ...
        allowed_parent_page_content_types = list(
            ContentType.objects.get_for_models(*self.model.allowed_parent_page_models()).values()
        )
