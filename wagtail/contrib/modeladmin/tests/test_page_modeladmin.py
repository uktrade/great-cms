...
class TestChooseParentViewForNonSuperuser(TestCase, WagtailTestUtils):
    ...
    def setUp(self):
        ...
        GroupPagePermission.objects.create(group=business_editors, page=business_index, permission_type="add")
        GroupPagePermission.objects.create(group=business_editors, page=another_business_index, permission_type="add")
