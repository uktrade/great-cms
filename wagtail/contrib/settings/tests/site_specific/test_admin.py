...
class TestSiteSettingMenu(TestCase, WagtailTestUtils):
    ...
    def test_menu_item_icon(self):
        menu_item = SettingMenuItem(IconSiteSetting, icon="tag", classnames="test-class")
    ...
    def test_menu_item_icon_fontawesome(self):
        menu_item = SettingMenuItem(IconSiteSetting, icon="fa-suitcase", classnames="test-class")
