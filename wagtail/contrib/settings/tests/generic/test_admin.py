...
class TestGenericSettingMenu(TestCase, WagtailTestUtils):
    def login_only_admin(self):
        ...
        user.user_permissions.add(
            Permission.objects.get_by_natural_key(codename="access_admin", app_label="wagtailadmin", model="admin")
        )
    ...
    def test_menu_item_icon(self):
        menu_item = SettingMenuItem(IconGenericSetting, icon="tag", classnames="test-class")
    ...
    def test_menu_item_icon_fontawesome(self):
        menu_item = SettingMenuItem(IconGenericSetting, icon="fa-suitcase", classnames="test-class")
