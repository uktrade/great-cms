...
class CloudflareBackend(BaseBackend):
    ...
    def __init__(self, params):
        ...
        self.cloudflare_api_key = params.pop("TOKEN", None) or params.pop("API_KEY", None)
...
class CloudfrontBackend(BaseBackend):
    def __init__(self, params):
        ...
        try:
            ...
            raise ImproperlyConfigured("The setting 'WAGTAILFRONTENDCACHE' requires the object 'DISTRIBUTION_ID'.")
...
class AzureFrontDoorBackend(AzureBaseBackend):
    def __init__(self, params):
        ...
        self._legacy_azure_library = self._is_legacy_azure_library(major_required=1, installed_version=__version__)
        ...
        try:
            ...
            raise ImproperlyConfigured("The setting 'WAGTAILFRONTENDCACHE' requires 'FRONT_DOOR_NAME' to be specified.")
...
class AzureCdnBackend(AzureBaseBackend):
    def __init__(self, params):
        ...
        self._legacy_azure_library = self._is_legacy_azure_library(major_required=10, installed_version=__version__)
