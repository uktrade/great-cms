...
from django.db.models.functions.datetime import Extract as ExtractDate, ExtractYear
...
class BaseSearchResults:
    ...
    def _clone(self):
        ...
        new = klass(self.backend, self.query_compiler, prefetch_related=self.prefetch_related)
