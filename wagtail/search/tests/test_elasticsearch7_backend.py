...
class TestElasticsearch7SearchQuery(TestCase):
    ...
    def test_and_filter(self):
        ...
        query = self.query_compiler_class(
            models.Book.objects.filter(title="Test", publication_date=datetime.date(2017, 10, 18)),
            "Hello",
        )
    ...
    def test_or_filter(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(Q(title="Test") | Q(publication_date=datetime.date(2017, 10, 18))),
            "Hello",
        )
    ...
    def test_gt_lookup(self):
        ...
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(publication_date__gt=datetime.datetime(2014, 4, 29)),
            "Hello",
        )
    ...
    def test_lt_lookup(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(publication_date__lt=datetime.datetime(2014, 4, 29)),
            "Hello",
        )
    ...
    def test_gte_lookup(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(publication_date__gte=datetime.datetime(2014, 4, 29)),
            "Hello",
        )
    ...
    def test_lte_lookup(self):
        # Create a query
        query = self.query_compiler_class(
            models.Book.objects.filter(publication_date__lte=datetime.datetime(2014, 4, 29)),
            "Hello",
        )
    ...
    def test_fuzzy_query(self):
        ...
        # Check it
        expected_result = {"match": {"_all_text": {"query": "Hello world", "fuzziness": "AUTO"}}}
        self.assertDictEqual(query_compiler.get_inner_query(), expected_result)
    ...
    def test_fuzzy_query_single_field(self):
        ...
        # Check it
        expected_result = {"match": {"title": {"query": "Hello world", "fuzziness": "AUTO"}}}
        self.assertDictEqual(query_compiler.get_inner_query(), expected_result)
        ...
        expected_result = {
            "properties": {
                ...
                "searchtests_novel__characters": {
                    "type": "nested",
                    "properties": {"name": {"type": "text", "boost": 0.25, "copy_to": "_all_text"}},
                },
                # Inherited
                "pk": {"type": "keyword", "store": True},
                "content_type": {"type": "keyword"},
