                ...
                migrations.SeparateDatabaseAndState(
                    ...
                    database_operations=[
                        migrations.RunSQL(
                            ...
                            reverse_sql=("DROP TABLE IF EXISTS %s_fts" % IndexEntry._meta.db_table),
                        ),
                        migrations.RunSQL(
                            sql=(
                            ...
                            reverse_sql=("DROP TRIGGER IF EXISTS insert_wagtailsearch_indexentry_fts"),
                        ),
                        migrations.RunSQL(
                            sql=(
                            ...
                            reverse_sql=("DROP TRIGGER IF EXISTS update_wagtailsearch_indexentry_fts"),
                        ),
                        migrations.RunSQL(
                            sql=(
                            ...
                            reverse_sql=("DROP TRIGGER IF EXISTS delete_wagtailsearch_indexentry_fts"),
                        ),
                    ],
                )
            )
