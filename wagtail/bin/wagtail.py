...
class CreateProject(Command):
    ...
    def run(self, project_name=None, dest_dir=None):
        ...
        print("Creating a Wagtail project called %(project_name)s" % {"project_name": project_name})  # noqa  # noqa
        ...
        print("Success! %(project_name)s has been created" % {"project_name": project_name})  # noqa  # noqa
        ...
        for dirpath, dirnames, filenames in os.walk(root_path):
            ...
            for filename in filenames:
                ...
                if diff:
                    ...
                    if change_count:
                        print(  # noqa
                            "%s - %d change%s" % (relative_path, change_count, pluralize(change_count))
                        )  # NOQA
