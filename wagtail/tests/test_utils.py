...
from django.utils.translation import _trans, gettext_lazy as _
...
class TestFindAvailableSlug(TestCase):
    def setUp(self):
        ...
        self.second_home_page = self.root_page.add_child(instance=Page(title="Second homepage", slug="home-1"))
...
class HashFileLikeTestCase(SimpleTestCase):
    ...
    def test_hashes_io(self):
        self.assertEqual(hash_filelike(BytesIO(b"test")), "a94a8fe5ccb19ba61c4c0873d391e987982fbbd3")
        self.assertEqual(hash_filelike(StringIO("test")), "a94a8fe5ccb19ba61c4c0873d391e987982fbbd3")

    def test_hashes_file(self):
        with self.test_file.open(mode="r") as f:
            self.assertEqual(hash_filelike(f), "9e58400061ca660ef7b5c94338a5205627c77eda")
