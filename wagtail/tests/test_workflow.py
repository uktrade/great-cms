...
class TestPageWorkflows(WagtailTestUtils, TestCase):
    ...
    def test_approve_workflow(self):
        ...
        self.assertEqual(object.live_revision, workflow_state.current_task_state.revision)
    ...
    def test_cancel_workflow(self):
        ...
        self.assertFalse(
            TaskState.objects.filter(workflow_state=workflow_state, status=TaskState.STATUS_IN_PROGRESS).exists()
        )
