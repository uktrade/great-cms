...
class TestStaticSitePaths(TestCase):
    def setUp(self):
        ...
        self.about_page = self.home_page.add_child(instance=SimplePage(title="About us", slug="about", content="hello"))
...
class TestLiveRevision(TestCase):
    ...
    def test_publish_method_will_set_live_revision(self):
        ...
        if settings.USE_TZ:
            ...
            self.assertEqual(
                ...
                page.first_published_at,
                timezone.make_naive(datetime.datetime(2014, 1, 1, 12, 0, 0, tzinfo=pytz.utc)),
            )
    ...
    def test_publish_with_future_go_live_does_not_set_live_revision(self):
        ...
        if settings.USE_TZ:
            ...
            self.assertEqual(
                about_us.last_published_at,
                timezone.make_naive(datetime.datetime(2014, 2, 1, 12, 0, 0, tzinfo=pytz.utc)),
            )
...
class TestCopyPage(TestCase):
    ...
    def test_copy_page_copies_revisions_and_doesnt_schedule(self):
        ...
        if settings.USE_TZ:
            ...
            christmas_event.save_revision(approved_go_live_at=datetime.datetime(2014, 9, 16, 9, 12, 00))
...
class TestCopyForTranslation(TestCase):
    ...
    def test_copy_homepage_slug_exists(self):
        ...
        self.root_page.add_child(
            instance=SimplePage(title="Old french homepage", slug="home-fr", content="Test content")
        )
...
class TestGetLock(TestCase):
    ...
    def test_when_locked_globally_with_old_setting_name(self):
        ...
        with self.assertWarnsMessage(
            ...
            "settings.WAGTAILADMIN_GLOBAL_PAGE_EDIT_LOCK has been renamed to " "settings.WAGTAILADMIN_GLOBAL_EDIT_LOCK",
        ):
            self.assertTrue(lock.for_user(christmas_event.owner))
            self.assertTrue(lock.for_user(moderator))
