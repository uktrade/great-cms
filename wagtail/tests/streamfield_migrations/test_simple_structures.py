...
class FieldChildBlockTest(TestCase):
    ...
    def test_combine_to_listblock(self):
        ...
        altered_raw_data = apply_changes_to_raw_data(
            raw_data=self.raw_data,
            block_path_str="",
            operation=StreamChildrenToListBlockOperation(block_name="char1", list_block_name="list1"),
            streamfield=models.SampleModel.content,
        )
    ...
    def test_combine_single_type_to_streamblock(self):
        ...
        altered_raw_data = apply_changes_to_raw_data(
            raw_data=self.raw_data,
            block_path_str="",
            operation=StreamChildrenToStreamBlockOperation(block_names=["char1"], stream_block_name="stream1"),
            streamfield=models.SampleModel.content,
        )
    ...
    def test_combine_multiple_types_to_streamblock(self):
        ...
        altered_raw_data = apply_changes_to_raw_data(
            raw_data=self.raw_data,
            block_path_str="",
            operation=StreamChildrenToStreamBlockOperation(block_names=["char1", "char2"], stream_block_name="stream1"),
            streamfield=models.SampleModel.content,
        )
