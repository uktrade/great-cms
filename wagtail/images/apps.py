...
class WagtailImagesAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        register_form_field_override(ForeignKey, to=Image, override={"widget": AdminImageChooser})
        ...
        register_comparison_class(ForeignKey, to=Image, comparison_class=ImageFieldComparison)
