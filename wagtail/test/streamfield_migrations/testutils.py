...
class MigrationTestMixin:
    ...
    def init_migration(self, revisions_from=None, operations_and_block_path=None):
        migration = Migration("test_migration", "wagtail_streamfield_migration_toolkit_test")
        migration_operation = MigrateStreamData(
            app_name=self.app_name,
            model_name=self.model.__name__,
            field_name="content",
            operations_and_block_paths=operations_and_block_path or self.default_operation_and_block_path,
