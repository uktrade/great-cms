...
class TestBulkUnpublish(TestCase, WagtailTestUtils):
    def setUp(self):
        ...
        self.child_pages = [
            SimplePage(title=f"Hello world!-{i}", slug=f"hello-world-{i}", content=f"hello-{i}") for i in range(1, 5)
        ]
    ...
    def setUp(self):
        ...
        self.grandchildren_pages = {
            self.pages_to_be_unpublished[0]: [
                SimplePage(title="Hello world!-a", slug="hello-world-a", content="hello-a")
            ],
