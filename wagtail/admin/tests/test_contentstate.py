...
class TestHtmlToContentState(TestCase):
    ...
    def test_inline_styles_at_start_of_bare_block(self):
        converter = ContentstateConverter(features=["bold", "italic"])
        result = json.loads(
            converter.from_database_format("""<b>Seriously</b>, stop talking about <i>Fight Club</i> already.""")
        )
        self.assertContentStateEqual(
            result,
            {
    ...
    def test_inline_styles_depend_on_features(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                ...
                "blocks": [
                    {
                        "inlineStyleRanges": [{"offset": 7, "length": 3, "style": "ITALIC"}],
                        "text": "You do not talk about Fight Club.",
                        "depth": 0,
                        "type": "unstyled",
                        "key": "00000",
    ...
    def test_document_link_with_missing_id(self):
        ...
        self.assertContentStateEqual(
            result,
            {
                "entityMap": {"0": {"mutability": "MUTABLE", "type": "DOCUMENT", "data": {}}},
                "blocks": [
                    {
                        "inlineStyleRanges": [],
                        "text": "a document link",
        ...
        self.assertContentStateEqual(
            result,
            {
                "blocks": [
                    ...
                    {
                        "key": "00000",
                        "inlineStyleRanges": [{"offset": 0, "length": 0, "style": "ITALIC"}],
                        "entityRanges": [],
                        "depth": 0,
                        "text": "",
                        "type": "unstyled",
