...
class TestHome(TestCase, WagtailTestUtils):
    ...
    def test_dashboard_panels(self):
        ...
        self.assertContains(response, '<script src="/static/testapp/js/clippy.js"></script>', html=True)
...
class TestTagsAutocomplete(TestCase, WagtailTestUtils):
    ...
    def test_tags_autocomplete(self):
        response = self.client.get(reverse("wagtailadmin_tag_autocomplete"), {"term": "test"})
    ...
    def test_tags_autocomplete_partial_match(self):
        response = self.client.get(reverse("wagtailadmin_tag_autocomplete"), {"term": "te"})
    ...
    def test_tags_autocomplete_different_term(self):
        response = self.client.get(reverse("wagtailadmin_tag_autocomplete"), {"term": "hello"})
...
class TestUserHasAnyPagePermission(TestCase, WagtailTestUtils):
    def test_superuser(self):
        user = self.create_superuser(username="superuser", email="admin@example.com", password="p")
    ...
    def test_moderator(self):
        user = self.create_user(username="moderator", email="mod@example.com", password="p")
