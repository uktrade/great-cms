...
class TestModerationList(TestCase, WagtailTestUtils):
    ...
    def setUp(self):
        ...
        self.edit_page_url = reverse("wagtailadmin_pages:edit", args=(self.revision.object_id,))
    ...
    def login_as_moderator_without_edit(self):
        ...
        moderator = self.create_user(username="moderator", email="moderator@email.com", password="password")
