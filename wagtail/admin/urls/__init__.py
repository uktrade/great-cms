...
from wagtail.admin.urls import (
    collections as wagtailadmin_collections_urls,
    pages as wagtailadmin_pages_urls,
    password_reset as wagtailadmin_password_reset_urls,
    reports as wagtailadmin_reports_urls,
    workflows as wagtailadmin_workflows_urls,
)
