...
class CreateView(TemplateResponseMixin, ContextMixin, HookResponseMixin, View):
    ...
    def save_action(self):
        ...
        messages.success(
            self.request,
            _("Page '%(page_title)s' created.") % {"page_title": self.page.get_admin_display_title()},
        )
    ...
    def publish_action(self):
        ...
        if self.page.go_live_at and self.page.go_live_at > timezone.now():
            ...
            messages.success(
                self.request,
                _("Page '%(page_title)s' created and published.") % {"page_title": self.page.get_admin_display_title()},
                buttons=buttons,
            )
    ...
    def get_context_data(self, **kwargs):
        ...
        bound_panel = self.edit_handler.get_bound_panel(request=self.request, instance=self.page, form=self.form)
