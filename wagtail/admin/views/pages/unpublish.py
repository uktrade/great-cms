...
class Unpublish(UnpublishView):
    ...
    def get_success_message(self):
        return self.success_message % {"page_title": self.object.get_admin_display_title()}
    ...
    def unpublish(self):
        hook_response = self.run_hook("before_unpublish_page", self.request, self.object)
        ...
        for object in self.objects_to_unpublish:
            action = UnpublishPageAction(object, user=self.request.user, include_descendants=include_descendants)
