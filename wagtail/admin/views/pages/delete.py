...
def delete(request, page_id):
    ...
    with transaction.atomic():
        ...
        if request.method == "POST":
            ...
            if request.POST.get("confirm_site_name") and request.POST.get("confirm_site_name") != wagtail_site_name:
            ...
            if continue_deleting:
                ...
                messages.success(
                    request,
                    _("Page '%(page_title)s' deleted.") % {"page_title": page.get_admin_display_title()},
                )
    ...
    return TemplateResponse(
        ...
        "wagtailadmin/pages/confirm_delete.html",
        {
            ...
            "translation_descendant_count": sum(
                [translation.get_descendants().filter(alias_of__isnull=True).count() for translation in pages_to_delete]
            ),
        },
    )
