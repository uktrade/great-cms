...
class UnpublishBulkAction(PageBulkAction):
        ...
        **kwargs,
        ...
        for page in objects:
            ...
            if include_descendants:
                for live_descendant_page in page.get_descendants().live().defer_streamfields().specific().iterator():
    ...
    def get_success_message(self, num_parent_objects, num_child_objects):
        ...
        if num_parent_objects == 1:
            ...
            if include_descendants:
                if num_child_objects == 0:
                    success_message = _("%(num_parent_objects)d pages have been unpublished") % {
