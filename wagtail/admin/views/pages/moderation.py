...
def approve_moderation(request, revision_id):
    ...
    if request.method == "POST":
        ...
        if revision.content_object.url is not None:
            buttons.append(messages.button(revision.content_object.url, _("View live"), new_window=False))
        buttons.append(
            messages.button(
...
def preview_for_moderation(request, revision_id):
    ...
    return page.make_preview_request(request, preview_mode, extra_request_attrs={"revision_id": revision_id})
