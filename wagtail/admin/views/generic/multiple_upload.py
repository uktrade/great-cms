...
class AddView(PermissionCheckedMixin, TemplateView):
    ...
    def get_edit_object_form_context_data(self):
        ...
        return {
            ...
            "delete_action": reverse(self.delete_object_url_name, args=(self.object.pk,)),
...
class DeleteView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.model = self.get_model()
        self.object = get_object_or_404(self.model, pk=object_id)
        object_id = self.object.pk  # retrieve object id cast to the appropriate type (usually int)
