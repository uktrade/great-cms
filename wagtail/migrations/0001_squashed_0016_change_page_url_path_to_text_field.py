    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "live",
                    models.BooleanField(default=True, verbose_name="Live", editable=False),
                ),
                (
                ...
                (
                    "url_path",
                    models.TextField(verbose_name="URL path", blank=True, editable=False),
                ),
                (
                    "seo_title",
                    models.CharField(
                ...
                (
                    "expired",
                    models.BooleanField(default=False, verbose_name="Expired", editable=False),
                ),
                (
                    "content_type",
                    models.ForeignKey(
                ...
                (
                    "locked",
                    models.BooleanField(default=False, verbose_name="Locked", editable=False),
                ),
                (
                ...
                (
                    "first_published_at",
                    models.DateTimeField(null=True, verbose_name="First published at", editable=False),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "approved_go_live_at",
                    models.DateTimeField(null=True, verbose_name="Approved go live at", blank=True),
                ),
                (
                    "page",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hostname",
                    models.CharField(verbose_name="Hostname", db_index=True, max_length=255),
                ),
                (
                    "port",
                    models.IntegerField(
