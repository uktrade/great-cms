...
class PublishRevisionAction:
    ...
    def _publish_revision(self, revision, object, user, changed, log_action, previous_revision):
        ...
        if object.live:
            ...
            if previous_revision:
                ...
                old_object_title = (
                    str(previous_revision_object) if str(object) != str(previous_revision_object) else None
                )
            else:
                try:
                    ...
                    previous = None
                old_object_title = (
                    str(previous.content_object) if previous and str(object) != str(previous.content_object) else None
                )
        else:
