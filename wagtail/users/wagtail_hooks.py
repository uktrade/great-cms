...
def register_users_menu_item():
    return UsersMenuItem(_("Users"), reverse("wagtailusers_users:index"), icon_name="user", order=600)
...
def register_groups_menu_item():
    return GroupsMenuItem(_("Groups"), reverse("wagtailusers_groups:index"), icon_name="group", order=601)
