...
class BaseGroupPagePermissionFormSet(forms.BaseFormSet):
    ...
    def __init__(self, data=None, files=None, instance=None, prefix="page_permissions"):
        ...
        if instance.pk is None:
            ...
            full_page_permissions = instance.page_permissions.select_related("page").order_by("page")
    ...
    def save(self):
        if self.instance.pk is None:
            raise Exception("Cannot save a GroupPagePermissionFormSet for an unsaved group instance")
        ...
        GroupPagePermission.objects.bulk_create(
            [
                GroupPagePermission(group=self.instance, page=page, permission_type=permission_type)
