...
region_choices_to_geocode_mapping = {
    EAST_OF_ENGLAND: EAST_GEO_CODE,
    EAST_MIDLANDS: EAST_MIDLANDS_GEO_CODE,
    LONDON: LONDON_GEO_CODE,
    NORTH_EAST: NORTH_EAST_GEO_CODE,
    NORTH_WEST: NORTH_WEST_GEO_CODE,
    NORTHERN_IRELAND: NORTHERN_IRELAND_GEO_CODE,
    SOUTH_EAST: SOUTH_EAST_GEO_CODE,
    SOUTH_WEST: SOUTH_WEST_GEO_CODE,
    SCOTLAND: SCOTLAND_GEO_CODE,
    WALES: WALES_GEO_CODE,
    WEST_MIDLANDS: WEST_MIDLANDS_GEO_CODE,
    YORKSHIRE_AND_THE_HUMBER: YORKSHIRE_AND_THE_HUMBER_GEO_CODE,
}
