# Generated by Django 4.1.10 on 2023-08-18 09:33
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('international_online_offer', '0027_rename_iooindexpage_eybindexpage'),
    ]

    operations = [
        migrations.CreateModel(
            name='EYBTradeShowPage',
            fields=[
                (
                    'page_ptr',
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='eyb_tradeshow_tagged_items',
                        to='international_online_offer.eybtradeshowpage',
                    ),
                ),
            ],
            options={
        ...
        migrations.RenameModel(
            old_name='IOOArticlePage',
            new_name='EYBArticlePage',
        ),
        migrations.RenameModel(
            old_name='IOOGuidePage',
            new_name='EYBGuidePage',
        ),
        migrations.RenameModel(
            old_name='IOOTradeShowsPage',
            new_name='EYBTradeShowsPage',
        ),
        migrations.RemoveField(
            model_name='iootradeshowpagetag',
            name='content_object',
        ),
        migrations.RemoveField(
            model_name='iootradeshowpagetag',
        ...
        migrations.DeleteModel(
            name='IOOTradeShowPage',
        ),
        migrations.DeleteModel(
            name='IOOTradeShowPageTag',
        ),
        migrations.AddField(
            model_name='eybtradeshowpagetag',
            name='tag',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='eyb_tagged_tradeshows',
                to='international_online_offer.iooarticletag',
            ),
        ),
        migrations.AddField(
            model_name='eybtradeshowpage',
            name='tags',
