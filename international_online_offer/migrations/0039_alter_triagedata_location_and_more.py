# Generated by Django 4.1.10 on 2023-11-21 17:26
...
class Migration(migrations.Migration):
    dependencies = [
        ('international_online_offer', '0038_alter_triagedata_location_city'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('NEWRY,_MOURNE_AND_DOWN', 'Newry, Mourne and Down'),
                    ...
                    ('ARMAGH_CITY,_BANBRIDGE_AND_CRAIGAVON', 'Armagh City, Banbridge and Craigavon'),
                    ...
                    ('BOURNEMOUTH,_CHRISTCHURCH_AND_POOLE', 'Bournemouth, Christchurch and Poole'),
                    ('TORRIDGE', 'Torridge'),
                    ('WILTSHIRE', 'Wiltshire'),
                    ('BRISTOL,_CITY_OF', 'Bristol, City of'),
                    ('TORBAY', 'Torbay'),
                    ('CORNWALL', 'Cornwall'),
                    ...
                    ('WALSALL', 'Walsall'),
                    ('WYCHAVON', 'Wychavon'),
                    ('HEREFORDSHIRE,_COUNTY_OF', 'Herefordshire, County of'),
                    ('REDDITCH', 'Redditch'),
                    ...
                    ('KINGSTON_UPON_HULL,_CITY_OF', 'Kingston upon Hull, City of'),
                    ('SELBY', 'Selby'),
