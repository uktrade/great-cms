...
;(() => {
  var e = {
      ...
      6120: (e, t) => {
        ...
        ;(n.components = n.components || {}),
          (n.components.cookieNotice = (function () {
            var e = $('#privacyCookieDomain').attr('value'),
              t = 'cookie_preferences_set',
              n = 'cookies_policy',
              r = '.cookie-notice'
            function o(t, n, r) {
              void 0 === r && (r = {})
              var o = t + '=' + n + '; domain=' + e + ';path=/;'
              if (r.days) {
                var i = new Date()
            ...
            function a(e, t, r) {
              ...
              return o(n, a, { days: 365 }), i
            }
            function u(e) {
              document
                .querySelectorAll(e)[0]
                .classList.remove('block', 'confirmation-message')
            }
            function l() {
              document
                .querySelectorAll(r)[0]
                .classList.add('confirmation-message')
              var e = document.querySelectorAll('.cookie-close')[0]
              e.addEventListener(
                'click',
                function (e) {
                ...
                e.addEventListener('keydown', function (e) {
                  ;(13 !== e.which && 32 !== e.which) || u(r)
                })
            }
            function c() {
              document.querySelectorAll(r)[0].classList.add('block')
            }
            function s() {
              o(t, 'true', { days: 365 })
            }
            ...
            function p() {
              var e = $('.cookie-notice-container'),
                t = $('<button>', {
                  class: 'cookie-close',
                  'aria-controls': 'header-cookie-notice',
                  'aria-label': 'Close this message',
                  id: 'dismiss-cookie-notice',
                })
            ...
            return {
              init: function (e) {
                ...
                n ||
                  ...
                  document
                    .querySelectorAll('.button-accept')[0]
                    .addEventListener('click', t, !1),
                  p())
              },
              getPolicyOrDefault: function () {
                var e = i(n),
                  t = { essential: !0, settings: !1, usage: !1, campaigns: !1 }
                if (!e) return t
                try {
                  var r = JSON.parse(e)
                  ;(t.campaigns = r.campaigns || !1),
                    (t.usage = r.usage || !1),
                    (t.settings = r.settings || !1)
                } catch (e) {
                  return t
                }
                return t
              },
              createPoliciesCookie: a,
              setPreferencesCookie: s,
              acceptAllCookiesAndShowSuccess: function (e) {
                !(function (e) {
                  e.preventDefault(), a(!0, !0, !0), s()
                })(e),
                  p(),
                  l(),
                  c()
              },
              getPreferencesCookie: f,
            }
          })()),
          e.exports && (e.exports = n.components.cookieNotice)
      },
      6266: (e, t, n) => {
        n(5767),
          n(8132),
      ...
      2923: (e, t, n) => {
        ...
        e.exports = function (e, t, n, m, y, g, b) {
          ...
          var w,
            ...
            P = O || E(y),
            A = y ? (T ? E('entries') : P) : void 0,
            N = ('Array' == t && C.entries) || O
          if (
            (N &&
              (k = s(N.call(new e()))) !== Object.prototype &&
              k.next &&
              (c(k, S, !0), r || 'function' == typeof k[f] || a(k, f, v)),
            T &&
              O &&
              O.name !== h &&
              ((_ = !0),
            ...
            if (
              ((w = { values: T ? P : E(h), keys: g ? P : E(d), entries: A }),
              b)
            )
              for (x in w) x in C || i(C, x, w[x])
            else o(o.P + o.F * (p || _), t, w)
          return w
        }
      },
      7462: (e, t, n) => {
      ...
      8440: (e, t, n) => {
        ...
        if (n(7057)) {
          var r = n(4461),
            ...
            Le = function () {
              return me.apply(je ? he.call(Pe(this)) : Pe(this), arguments)
            },
            De = {
              ...
              fill: function (e) {
                return L.apply(Pe(this), arguments)
              },
              filter: function (e) {
                return Ne(
                  this,
            ...
            ze = function (e, t) {
              return Ne(this, he.call(Pe(this), e, t))
            },
            Ue = function (e) {
              Pe(this)
              ...
              b
                ? ((h = n(function (e, n, r, o) {
                    ...
                    var i,
                      ...
                      d = 0
                    if (x(n)) {
                      if (!(n instanceof Y || (l = w(n)) == Q || l == $))
                        return ke in n ? Me(h, n) : Re.call(h, n)
                      ;(i = n), (d = Oe(r, t))
                      var y = n.byteLength
                      if (void 0 === o) {
                        if (y % t) throw V(Se)
                        if ((a = y - d) < 0) throw V(Se)
                      } else if ((a = v(o) * t) + d > y) throw V(Se)
                      u = a / t
                    } else (u = m(n)), (i = new Y((a = u * t)))
                    for (
                      p(e, '_d', { b: i, o: d, l: a, e: u, v: new X(i) });
                      f < u;
                ...
                : (i(function () {
                  ...
                  J(
                    g !== Function.prototype ? _(y).concat(_(g)) : _(y),
                    function (e) {
                      e in h || p(h, e, y[e])
                    }
                  ),
      ...
      1125: (e, t, n) => {
        ...
        function G(e, t, n, r, o, i) {
          var a = d(+n)
          if (a + t > e[j]) throw S(w)
          for (var u = e[I]._b, l = a + e[L], c = r(+o), s = 0; s < t; s++)
            u[l + s] = c[i ? s : t - s - 1]
        }
        if (a.ABV) {
          if (
          ...
          (x = function (e) {
            ...
            (k = function (e, t, n) {
              ...
              ;(this[I] = e), (this[L] = o), (this[j] = n)
            }),
            o && (Q(x, F, '_l'), Q(k, M, '_b'), Q(k, F, '_l'), Q(k, R, '_o')),
            l(k.prototype, {
              getInt8: function (e) {
              ...
              getFloat32: function (e) {
                return z($(this, 4, e, arguments[1]), 23, 4)
              },
              getFloat64: function (e) {
                return z($(this, 8, e, arguments[1]), 52, 8)
              },
              setInt8: function (e, t) {
                G(this, 1, e, W, t)
              },
        ...
        n(8082)('replace', 2, function (e, t, n, h) {
          return [
            ...
            function (e, t) {
              ...
              for (var w, x = '', k = 0, E = 0; E < g.length; E++) {
                b = g[E]
                for (
                  var S = String(b[0]),
                ...
                } else A = v(S, p, T, _, O, t)
                T >= k && ((x += p.slice(k, T) + A), (k = T + S.length))
              }
              return x + p.slice(k)
            },
          ]
            ...
            [
              ...
              function (e, t) {
                ...
                for (var x = 0, k = 0, E = []; k < p.length; ) {
                  ...
                  if (
                    null === T ||
                    (S = f(u(b.lastIndex + (h ? 0 : k)), p.length)) === x
                  )
                    k = a(p, k, y)
                  else {
      ...
      5767: (e, t, n) => {
        ...
        var r = n(3816),
          ...
          X = function (e) {
            ...
            return (
              !(this === B && o(U, e) && !o(W, e)) &&
              (!(t || !o(this, e) || !o(U, e) || (o(this, j) && this[j][e])) ||
                t)
            )
          },
          J = function (e, t) {
            if (((e = x(e)), (t = k(t, !0)), e !== B || !o(U, t) || o(W, t))) {
              var n = A(e, t)
              return (
          ...
          Z = function (e) {
            for (var t, n = M(x(e)), r = [], i = 0; n.length > i; )
              o(U, (t = n[i++])) || t == j || t == l || r.push(t)
            return r
          },
          ee = function (e) {
            for (
              var t, n = e === B, r = M(n ? W : x(e)), i = [], a = 0;
              r.length > a;
        ...
        V ||
          (u(
            (F = function () {
              ...
              return i && q && Q(B, e, { configurable: !0, set: t }), $(e)
            }).prototype,
            'toString',
            function () {
              return this._k
          ...
          (n(4682).f = X),
          (C.f = ee),
          i && !n(4461) && u(B, 'propertyIsEnumerable', X, !0),
          (h.f = function (e) {
            return $(d(e))
          })),
        ...
        a(a.S + a.F * ie, 'Object', {
          ...
          F.prototype[L] || n(7728)(F.prototype, L, F.prototype.valueOf),
          f(F, 'Symbol'),
          f(Math, 'Math', !0),
          f(r.JSON, 'JSON', !0)
      },
      ...
      147: (e, t, n) => {
        ...
        var r,
          ...
          w = (e.exports = n(5795)(h, g, b, c, !0, !0))
        p &&
          d &&
      ...
      7300: (e, t, n) => {
        ...
        a.push([
          e.id,
          '.x1Z82qtau38Eyr8Q_Gqw {\n  font-size: 24px;\n  margin: 0;\n}\n\n.uUk7CzF5xEk1XyhwsJzY {\n  font-size: 19px;\n  margin-bottom: 30px;\n  margin-top: 30px;\n  text-align: left;\n}\n\n.ISmc4WuoGJ0Qlk1gaUsJ {\n  cursor: pointer;\n  font-size: 19px;\n  margin-bottom: 0;\n  height: 50px;\n  padding: 0;\n  line-height: 44px;\n  font-weight: normal;\n}\n\n.ReactModal__Overlay {\n  z-index: 1000;\n  background-color: rgba(0, 0, 0, 0.5)!important;\n}\n\n.ReactModal__Content {\n  background: #ffffff;\n  padding: 30px!important;\n  bottom: auto !important;\n  right: auto !important;\n  top: 50% !important;\n  left: 50% !important;\n  transform: translate(-50%, -50%);\n  width: 95% !important;\n  max-height: fit-content;\n  max-width: 600px;\n}\n\n.LDZ6yDEmf5B4GiOOm6nw {\n  display: inline-block;\n  width: 20px;\n}\n\n@media (min-width: 500px) {\n  .ReactModal__Content {\n    padding: 52px!important;\n\n  }\n\n  .iIbNYPOtt6E5sOWUa3Fa {\n    display: flex;\n  }\n  .uUk7CzF5xEk1XyhwsJzY {\n    margin-top: 25px;\n    margin-bottom: 45px;\n  }\n  .ISmc4WuoGJ0Qlk1gaUsJ {\n    width: 50%;\n  }\n}\n',
          '',
          {
            version: 3,
            sources: [
              'webpack://./react-components/src/components/CookiesModal/CookiesModal.css',
            ],
            names: [],
            mappings:
              'AAAA;EACE,eAAe;EACf,SAAS;AACX;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,gBAAgB;EAChB,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,UAAU;EACV,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,8CAA8C;AAChD;;AAEA;EACE,mBAAmB;EACnB,uBAAuB;EACvB,uBAAuB;EACvB,sBAAsB;EACtB,mBAAmB;EACnB,oBAAoB;EACpB,gCAAgC;EAChC,qBAAqB;EACrB,uBAAuB;EACvB,gBAAgB;AAClB;;AAEA;EACE,qBAAqB;EACrB,WAAW;AACb;;AAEA;EACE;IACE,uBAAuB;;EAEzB;;EAEA;IACE,aAAa;EACf;EACA;IACE,gBAAgB;IAChB,mBAAmB;EACrB;EACA;IACE,UAAU;EACZ;AACF',
            sourcesContent: [
          ...
          (a.locals = {
            heading: 'x1Z82qtau38Eyr8Q_Gqw',
            synopsis: 'uUk7CzF5xEk1XyhwsJzY',
            button: 'ISmc4WuoGJ0Qlk1gaUsJ',
            buttonSeperator: 'LDZ6yDEmf5B4GiOOm6nw',
      ...
      4448: (e, t, n) => {
            ...
            extractEvents: function (e, t, n, r) {
              ...
              return (
                ...
                (e = tr
                  ...
                  ? (((t = Xn.getPooled(or.beforeInput, t, n, r)).data = e),
                    zn(t))
                  : (t = null),
        ...
        function kr(e, t, n) {
          'focus' === e
            ? (wr(), (vr = n), (hr = t).attachEvent('onpropertychange', xr))
            : 'blur' === e && wr()
        }
        function Er(e) {
        ...
        function $o(e) {
          return null === Do ? ((Do = [e]), (zo = To(Ao, Ko))) : Do.push(e), Io
        }
        function Go() {
          if (null !== zo) {
            var e = zo
        ...
        function Ko() {
          if (!Uo && null !== Do) {
            ...
            try {
              ...
              throw (null !== Do && (Do = Do.slice(e + 1)), To(Ao, Go), t)
            } finally {
              Uo = !1
            }
          }
        ...
        function _i(e) {
          ...
          function c(e, t, n, r) {
            return null !== t && t.elementType === n.type
              ...
              : (((r = Nl(n.type, n.key, n.props, null, e.mode, r)).ref = Si(
                  e,
                  t,
                  n
                )),
          ...
          function p(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case ee:
                  return (
                    ((n = Nl(t.type, t.key, t.props, null, e.mode, n)).ref = Si(
                      e,
                      null,
                      t
                    )),
        ...
        function Ri(e, t) {
          switch ((fo(Mi, t), fo(Ni, e), fo(Ai, Pi), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function zi(e) {
          for (var t = e; null !== t; ) {
            if (13 === t.tag) {
              ...
              if (
                null !== n &&
                (null === (n = n.dehydrated) || n.data === vn || n.data === mn)
              )
                return t
        ...
        function Yi(e, t, n, r, o, i) {
          if (
            ...
            (t.updateQueue = null),
            (t.expirationTime = 0),
            (Wi.current = null === e || null === e.memoizedState ? ba : wa),
            (e = n(r, o)),
            t.expirationTime === Vi)
          ) {
            i = 0
            ...
            do {
              ...
              if (s < Vi) {
                ...
                null === l ? ((u = l = f), (i = r)) : (l = l.next = f),
                  s > Hi.expirationTime && ((Hi.expirationTime = s), sl(s))
              } else
                null !== l &&
                  (l = l.next = {
                    expirationTime: 1073741823,
        ...
        function ya(e, t, n) {
          ...
          if (
            ...
            ($i = !0), (o.expirationTime = Vi), (Hi.expirationTime = Vi)
          else {
            if (
              0 === e.expirationTime &&
        ...
        function Ia(e, t, n, r, o, i) {
          if (null === e) {
            ...
            return 'function' != typeof a ||
              ...
              ? (((e = Nl(n.type, null, r, null, t.mode, i)).ref = t.ref),
                (e.return = t),
                (t.child = e))
                ...
                if (((e = Fi(Ai.current)), Pa(t))) {
                  ...
                  switch (((r[_n] = t), (r[Cn] = u), i)) {
                    ...
                    case 'select':
                      ...
                      break
                    case 'textarea':
                      Ne(r, u), Qt('invalid', r), un(n, 'onChange')
                  }
                      ...
                      'children' === l
                        ? 'string' == typeof c
                          ...
                          : 'number' == typeof c &&
                            r.textContent !== '' + c &&
                            (e = ['children', '' + c])
                        : S.hasOwnProperty(l) && null != c && un(n, l)
                    }
                  switch (i) {
                    case 'input':
                      we(r), _e(r, u, !0)
                  ...
                  : ((n = null !== r),
                    ...
                    n &&
                      ...
                      0 != (1 & Di.current)
                        ? Nu === Su && (Nu = Tu)
                        : ((Nu !== Su && Nu !== Tu) || (Nu = _u),
                          0 !== ju && null !== Ou && (Ll(Ou, Au), Dl(Ou, ju)))),
                    (n || r) && (t.effectTag |= 4),
                    null)
              )
            case 4:
        ...
        function Za(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((Ii(), so(vo), so(ho), 0 != (64 & (t = e.effectTag))))
                throw Error(a(285))
        ...
        function Yu() {
          return 0 != (48 & Cu)
            ...
            : 0 !== Ku
            ? Ku
            : (Ku = 1073741821 - ((Bo() / 10) | 0))
        }
        function Xu(e, t, n) {
          if (0 == (2 & (t = t.mode))) return 1073741823
          var r = Vo()
          if (0 == (4 & t)) return 99 === r ? 1073741823 : 1073741822
          if (0 != (16 & Cu)) return Au
          ...
          return null !== Ou && e === Au && --e, e
        }
        function Ju(e, t) {
          if (50 < $u) throw (($u = 0), (Gu = null), Error(a(185)))
          if (null !== (e = Zu(e, t))) {
            var n = Vo()
            1073741823 === t
              ? 0 != (8 & Cu) && 0 == (48 & Cu)
        ...
        function Zu(e, t) {
          ...
          return (
            null !== o &&
              (Ou === o && (sl(t), Nu === _u && Ll(o, Au)), Dl(o, t)),
            o
          )
        }
        function el(e) {
        ...
        function tl(e) {
          if (0 !== e.lastExpiredTime)
            (e.callbackExpirationTime = 1073741823),
              ...
              (e.callbackNode = $o(rl.bind(null, e)))
          else {
            var t = el(e),
              n = e.callbackNode
            if (0 === t)
        ...
        function nl(e, t) {
          ...
          if (0 !== n) {
            ...
            if ((bl(), (e === Ou && n === Au) || al(e, n), null !== Pu)) {
              var r = Cu
              Cu |= 16
              for (var o = ll(); ; )
                try {
                  ...
                  case 5:
                    if (1073741823 !== Fu && null !== Iu) {
                      ...
                      if (
                        ...
                        Ll(e, n), (e.timeoutHandle = xn(ml.bind(null, e), r))
                        break
                      }
                    }
                    ml(e)
        ...
        function rl(e) {
          var t = e.lastExpiredTime
          if (((t = 0 !== t ? t : 1073741823), 0 != (48 & Cu)))
            throw Error(a(327))
          if ((bl(), (e === Ou && t === Au) || al(e, t), null !== Pu)) {
            var n = Cu
            Cu |= 16
            for (var r = ll(); ; )
              try {
        ...
        function al(e, t) {
          ...
          if ((-1 !== n && ((e.timeoutHandle = -1), kn(n)), null !== Pu))
        ...
        function ll() {
          var e = ku.current
          return (ku.current = ga), null === e ? ga : e
        }
        function cl(e, t) {
          e < Fu && 2 < e && (Fu = e),
            null !== t && e < Ru && 2 < e && ((Ru = e), (Iu = t))
        }
        function sl(e) {
          e > ju && (ju = e)
        }
        ...
        function hl(e) {
          ...
          do {
            ...
            if (((e = Pu.return), 0 == (2048 & Pu.effectTag))) {
              if (
                ((t = Ja(t, Pu, Au)), 1 === Au || 1 !== Pu.childExpirationTime)
              ) {
        ...
        function yl(e, t) {
          ...
          if (
                ...
                for (u = e, l = t; null !== zu; ) {
                  ...
                  switch (1038 & w) {
                    case 2:
                      ...
                      break
                    case 6:
                      fu(zu), (zu.effectTag &= -3), vu(zu.alternate, zu)
                      break
                    case 1024:
                      zu.effectTag &= -1025
                      break
                    case 1028:
                      ;(zu.effectTag &= -1025), vu(zu.alternate, zu)
                      break
                    case 4:
                      vu(zu.alternate, zu)
                      break
            ...
            ;(qt = !!yn), (gn = yn = null), (e.current = n), (zu = o)
            do {
              try {
                for (w = e; null !== zu; ) {
                  var E = zu.effectTag
                  if ((36 & E && uu(w, zu.alternate, zu), 128 & E)) {
                    x = void 0
                    var S = zu.ref
                    if (null !== S) {
                      var T = zu.stateNode
        ...
        function wl() {
          if (null === Hu) return !1
          var e = Hu
          if (((Hu = null), 0 != (48 & Cu))) throw Error(a(331))
          var t = Cu
        ...
        function xl(e, t, n) {
          fi(e, (t = gu(e, (t = eu(n, t)), 1073741823))),
            null !== (e = Zu(e, 1073741823)) && tl(e)
        }
        function kl(e, t) {
          if (3 === e.tag) xl(e, e, t)
          else
            for (var n = e.return; null !== n; ) {
              ...
              if (1 === n.tag) {
                ...
                if (
                  ...
                  fi(n, (e = bu(n, (e = eu(t, e)), 1073741823))),
                    null !== (n = Zu(n, 1073741823)) && tl(n)
                  break
                }
              }
              n = n.return
        ...
        function El(e, t, n) {
          ...
          null !== r && r.delete(t),
            Ou === e && Au === n
              ? Nu === _u || (Nu === Tu && 1073741823 === Fu && Bo() - Du < 500)
                ? al(e, Au)
                : (Lu = !0)
              : jl(e, n) &&
        ...
        ;(Hl.prototype.render = function (e) {
          ...
          (vt = function (e) {
            13 === e.tag && (Ju(e, 3), Vl(e, 3))
          }),
          (mt = function (e) {
            if (13 === e.tag) {
              var t = Yu()
              Ju(e, (t = Xu(t, e, null))), Vl(e, t)
            }
          }),
          (O = function (e, t, n) {
            switch (t) {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
          (t.default = function (e, t) {
            ...
            if (n.length) {
              ...
              if (
                (u !== document.activeElement || i || (r = a),
                a === document.activeElement && i && (r = u),
                r)
              )
              ...
              if (
                ...
                if ((c > -1 && (c += i ? -1 : 1), void 0 === (r = n[c])))
                  return t.preventDefault(), void (r = i ? u : a).focus()
              ...
              l > u
                ? ((e.sortIndex = l),
                  ...
                  null === T(O) &&
                    e === T(P) &&
                    (I ? o() : (I = !0), r(L, l - u)))
                : ((e.sortIndex = a), S(O, e), R || F || ((R = !0), n(D))),
              e
            )
          }),
        ...
        function u(e, t) {
          for (var n = {}, r = [], o = 0; o < e.length; o++) {
            ...
            ;-1 !== f
              ...
              : i.push({ identifier: s, updater: v(p, t), references: 1 }),
              r.push(s)
          }
          return r
        }
  ...
  ;(() => {
    ...
    var e = n(7294),
      ...
      p = n.n(f)
    const d = JSON.parse(
      '{"en":{"Tell us whether you accept cookies":"Tell us whether you accept cookies","We use":"We use","cookies to collect information":"cookies to collect information","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.","Accept all cookies":"Accept all cookies","Set cookie preferences":"Set cookie preferences"},"es":{"Tell us whether you accept cookies":"Dinos si aceptas cookies","We use":"Utilizamos","cookies to collect information":"cookies para recopilar información","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"sobre cómo utilizas great.gov.uk. Utilizamos esta información para hacer que el sitio web funcione lo mejor posible y mejorar los servicios gubernamentales.","Accept all cookies":"Aceptar todas las cookies","Set cookie preferences":"Configurar preferencias de cookies"},"ar":{"Tell us whether you accept cookies":"أخبرنا ما إذا كنت توافق على ملفات تعريف الارتباط","We use":"نستخدم","cookies to collect information":"ملفات تعريف الارتباط لجمع المعلومات","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"حول كيفية استخدامك لـ great.gov.uk. نستخدم هذه المعلومات لجعل الموقع يعمل بأفضل شكل ممكن وتحسين الخدمات الحكومية.","Accept all cookies":"قبول جميع ملفات تعريف الارتباط","Set cookie preferences":"تعيين تفضيلات ملفات تعريف الارتباط"},"fr":{"Tell us whether you accept cookies":"Dites-nous si vous acceptez les cookies","We use":"Nous utilisons","cookies to collect information":"cookies pour collecter des informations","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"sur la façon dont vous utilisez great.gov.uk. Nous utilisons ces informations pour faire fonctionner le site Web au mieux et améliorer les services gouvernementaux.","Accept all cookies":"Accepter tous les cookies","Set cookie preferences":"Définir les préférences en matière de cookies"},"pt":{"Tell us whether you accept cookies":"Diga-nos se você aceita cookies","We use":"Nós usamos","cookies to collect information":"cookies para coletar informações","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"sobre como você usa great.gov.uk. Usamos essas informações para fazer o site funcionar da melhor maneira possível e melhorar os serviços do governo.","Accept all cookies":"Aceitar todos os cookies","Set cookie preferences":"Definir preferências de cookies"},"ko":{"Tell us whether you accept cookies":"쿠키 허용에 동의하는 지 확인해주세요","We use":"우리는 귀하가 great.gov.uk를 어떻게 사용하는 지 정보 취합을 위해 쿠키를 활용합니다.","cookies to collect information":"","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"우리는 웹사이트를 운영하고, 정부 서비스를 개선하기 위해 정보를 활용합니다.","Accept all cookies":"모든 쿠키 허용","Set cookie preferences":"쿠키 설정 변경"},"zh":{"Tell us whether you accept cookies":"請告訴我們是否接受cookies","We use":"我們使用 ","cookies to collect information":"cookies收集資訊","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"以了解您如何使用great.gov.uk 網站。這些資訊將用於改善網站運作及政府服務。","Accept all cookies":"接受所有cookies","Set cookie preferences":"設定cookies偏好"},"ms":{"Tell us whether you accept cookies":"Beritahu kami sama ada anda menerima kuki","We use":"Kami guna","cookies to collect information":"kuki untuk mengumpul maklumat","about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.":"tentang cara anda menggunakan great.gov.uk. Kami menggunakan maklumat ini untuk menjadikan tapak web berfungsi sebaik mungkin dan meningkatkan perkhidmatan kerajaan.","Accept all cookies":"Terima semua kuki","Set cookie preferences":"Tetapkan pilihan kuki"}}'
    )
    var h = ['element']
    function v(e, t) {
    ...
    function m(t) {
      var n,
        ...
        o,
        i =
          ((r = e.useState(null === s().getPreferencesCookie())),
          (o = 2),
          (function (e) {
        ...
        h = function (e) {
          if (f.current) {
            var t = e.target.closest('.ReactModal__Content')
            ;(t && t != e.target) || !n || n.focus()
          } else f.current = !0
        },
        m = t.lang ? t.lang.substring(0, 2) : 'en'
      return (
        Object.keys(d).includes(m) || (m = 'en'),
        e.useEffect(function () {
          return (
            document.body.addEventListener('focusin', h),
            function () {
              document.body.removeEventListener('focusin', h)
            }
          )
        }, []),
        e.createElement(
          u(),
          { isOpen: a, contentLabel: 'Cookies consent manager' },
          e.createElement(
            'h2',
            { className: ''.concat(p().heading, ' heading-medium') },
            d[m]['Tell us whether you accept cookies']
          ),
          e.createElement(
            'p',
            { className: ''.concat(p().synopsis, ' body-text') },
            d[m]['We use'],
            ' ',
            e.createElement(
              'a',
              {
                className: 'link',
                href: t.privacyCookiesUrl,
                ref: function (e) {
                  return (n = e)
                },
              },
              d[m]['cookies to collect information']
            ),
            ' ',
            d[m][
              'about how you use great.gov.uk. We use this information to make the website work as well as possible and improve government services.'
            ]
          ),
          e.createElement(
            'div',
            ...
            e.createElement(
              'a',
              {
                className: ''.concat(p().button, ' button primary-button'),
                href: '#',
                onClick: function (e) {
                  s().acceptAllCookiesAndShowSuccess(e),
                    l({ event: 'cookies_policy_accept' }),
                    l({ event: 'gtm.dom' }),
                    c(!1)
                },
              },
              d[m]['Accept all cookies']
            ),
            e.createElement('span', { className: p().buttonSeperator }),
            e.createElement(
              'a',
              {
                className: ''.concat(p().button, ' button primary-button'),
                href: t.preferencesUrl + window.location.search,
              },
              d[m]['Set cookie preferences']
            )
          )
        )
      )
    }
    m.propTypes = { preferencesUrl: o().string.isRequired }
    const y = {
      CookiesModal: function (t) {
        var n = t.element,
          r = (function (e, t) {
            if (null == e) return {}
            var n,
        ...
        u().setAppElement(n), i.render(e.createElement(m, r), n)
      },
      CookiesNotice: s(),
    }
  })(),
    (components = r.default)
})()
