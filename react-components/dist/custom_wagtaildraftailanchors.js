var custom_wagtaildraftailanchors;
/******/ (() => { // webpackBootstrap
...
var CopyAnchorButton = function CopyAnchorButton(_ref) {
  ...
  var classes = 'button Tooltip__button';
...
var _TooltipEntity = /*#__PURE__*/function (_Component) {
  function _TooltipEntity(props) {
    var _this;
    _classCallCheck(this, _TooltipEntity);
    _this = _callSuper(this, _TooltipEntity, [props]);
    _this.state = {
      showTooltipAt: null
    };
  ...
  _inherits(_TooltipEntity, _Component);
  return _createClass(_TooltipEntity, [{
    key: "openTooltip",
    ...
    value: function render() {
      ...
      var _contentState$getEnti = contentState.getEntity(entityKey).getData(),
        ...
        anchor = _contentState$getEnti.anchor;
      var slugified = slugify__WEBPACK_IMPORTED_MODULE_1___default()(anchor);
      var anchorText = "#".concat(slugified);
      return /*#__PURE__*/React.createElement("a", {
        role: "button",
        onMouseUp: this.openTooltip,
        className: "TooltipEntity"
      }, /*#__PURE__*/React.createElement("sub", null, /*#__PURE__*/React.createElement(Icon, {
        name: "anchor",
      ...
      }, "Remove"), /*#__PURE__*/React.createElement(CopyAnchorButton, {
        identifier: slugified
      }))));
    }
  }]);
}(react__WEBPACK_IMPORTED_MODULE_0__.Component); // Implement the new APIs.
var DECORATORS = [];
var CONTROLS = [];
var DRAFT_PLUGINS = [];
...
var AnchorIdentifierSource = /*#__PURE__*/function (_React$Component) {
  function AnchorIdentifierSource() {
    ...
    return _callSuper(this, AnchorIdentifierSource, arguments);
  }
  _inherits(AnchorIdentifierSource, _React$Component);
  return _createClass(AnchorIdentifierSource, [{
    ...
    value: function componentDidMount() {
      ...
      var anchor = window.prompt('Create/ Edit an anchor link name');

      // Uses the Draft.js API to create a new entity with the right data.
      if (anchor) {
        var contentWithEntity = content.createEntity(entityType.type, 'MUTABLE', {
          anchor: slugify__WEBPACK_IMPORTED_MODULE_1___default()(anchor.toLowerCase())
        });
...
var AnchorIdentifier = function AnchorIdentifier(props) {
  ...
  return /*#__PURE__*/React.createElement(_TooltipEntity, _extends({}, props, getAnchorIdentifierAttributes(data)));
};
...
custom_wagtaildraftailanchors = __webpack_exports__["default"];
/******/ })()
;
//# sourceMappingURL=custom_wagtaildraftailanchors.js.map