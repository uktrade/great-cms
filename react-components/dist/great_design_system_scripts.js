...
var great_design_system_scripts
;(() => {
  var t = {
      6940: () => {
        ;(() => {
          ...
          function s(t, e = {}) {
            ...
            function n() {
              var s
              null == (s = e.onBlur) || s.call(t),
                i || t.removeAttribute('tabindex')
            }
          ...
          class h extends r {
            constructor(t) {
              super(
                'string' == typeof t
                  ? t
                  : o(t, 'Root element (`$root`) already initialised')
              ),
                (this.name = 'InitError')
            }
          }
          class d {
            ...
            constructor(t) {
              ...
              if ('string' != typeof e.moduleName)
                throw new h('`moduleName` not defined in component')
          ...
          const u = Symbol.for('configOverride')
          class m extends d {
            [u](t) {
              return {}
            }
            ...
            constructor(t, e) {
              ...
              const i = (function (t, e) {
                ...
                const s = {}
                for (const [i, n] of Object.entries(t.schema.properties))
                  i in e && (s[i] = p(e[i], n)),
                    'object' === (null == n ? void 0 : n.type) &&
                      (s[i] = v(t.schema, e, i))
                return s
              })(s, this._$root.dataset)
              this._config = g(s.defaults, null != e ? e : {}, this[u](i), i)
            }
          }
          function p(t, e) {
            const s = t ? t.trim() : ''
            ...
            switch (
              (n ||
                (['true', 'false'].includes(s) && (n = 'boolean'),
                s.length > 0 && isFinite(Number(s)) && (n = 'number')),
              n)
            ) {
              case 'boolean':
                i = 'true' === s
          ...
          class f {
            ...
            t(t, e) {
              ...
              if (
                ...
                const i = s[this.getPluralSuffix(t, e.count)]
                i && (s = i)
              }
              if ('string' == typeof s) {
                if (s.match(/%{(.\S+)}/)) {
            ...
            selectPluralFormUsingFallbackRules(t) {
              ...
              return e ? f.pluralRules[e](t) : 'other'
            }
            getPluralRulesForLocale() {
              const t = this.locale.split('-')[0]
              for (const e in f.pluralRulesMap) {
                const s = f.pluralRulesMap[e]
          ...
          class b extends m {
            constructor(t, e = {}) {
              super(t, e),
                ...
                (this.i18n = new f(this.config.i18n))
            ...
            constructHeaderMarkup(t, e) {
              ...
              for (const t of Array.from(s.attributes))
                'id' !== t.name && o.setAttribute(t.name, t.value)
              ...
              h.classList.add(this.sectionShowHideToggleFocusClass),
                c.appendChild(h)
              ...
              if (
                ...
                Array.from(n.childNodes).forEach((t) => e.appendChild(t)),
                  n.remove(),
                  o.appendChild(t),
                  o.appendChild(this.getButtonPunctuationEl())
              }
              o.appendChild(c), i.removeChild(s), i.appendChild(o)
            }
            onBeforeMatch(t) {
              const e = t.target
            ...
            updateShowAllButton(t) {
              this.$showAllButton &&
                ...
                this.$showAllIcon.classList.toggle(
                  this.downChevronIconClass,
                  !t
                ))
            }
          ...
          ;(b.moduleName = 'govuk-accordion'),
            (b.defaults = Object.freeze({
              i18n: {
          ...
          ;(w.moduleName = 'govuk-button'),
            (w.defaults = Object.freeze({ preventDoubleClick: !1 })),
          ...
          class k extends m {
            ...
            constructor(t, e = {}) {
              ...
              const r = (function (t, e) {
                ...
                for (const [i, n] of Object.entries(t)) {
                  const t = []
                  if (Array.isArray(n)) {
                    for (const { required: s, errorMessage: i } of n)
                      s.every((t) => !!e[t]) || t.push(i)
                    'anyOf' !== i || n.length - t.length >= 1 || s.push(...t)
                  }
                }
                return s
              })(k.schema, this.config)
              if (r[0]) throw new c(o(k, r[0]))
              ;(this.i18n = new f(this.config.i18n, {
                locale: y(this.$root, 'lang'),
              })),
                (this.maxLength =
                  null !=
                  (s =
                    null != (i = this.config.maxwords)
                      ? i
              ...
              ;`${h.textContent}`.match(/^\s*$/) &&
                (h.textContent = this.i18n.t('textareaDescription', {
              ...
              ;(u.className = h.className),
                ...
                h.classList.add('govuk-visually-hidden'),
            ...
            count(t) {
              var e
              return this.config.maxwords
                ? (null != (e = t.match(/\S+/g)) ? e : []).length
                : t.length
            }
            getCountMessage() {
          ...
          class $ extends d {
            ...
            syncConditionalRevealWithInputState(t) {
              ...
              if (
                null != s &&
                s.classList.contains('govuk-checkboxes__conditional')
              ) {
                const e = t.checked
          ...
          $.moduleName = 'govuk-checkboxes'
          class C extends m {
            constructor(t, e = {}) {
              super(t, e),
                this.config.disableAutoFocus || s(this.$root),
                this.$root.addEventListener('click', (t) => this.handleClick(t))
            }
            handleClick(t) {
              const e = t.target
            ...
            focusTarget(e) {
              ...
              return (
                !!n && (n.scrollIntoView(), i.focus({ preventScroll: !0 }), !0)
              )
            }
              ...
              if (s) {
                ...
                if (e.length) {
                  ...
                  if (
                    n.height &&
                    window.innerHeight &&
                    n.top + n.height - i < window.innerHeight / 2
                  )
                    return s
                }
              }
          ...
          ;(C.moduleName = 'govuk-error-summary'),
            (C.defaults = Object.freeze({ disableAutoFocus: !1 })),
          ...
          class E extends m {
            constructor(t, e = {}) {
              ...
              ;(this.i18n = new f(this.config.i18n)), (this.$button = s)
          ...
          ;(E.moduleName = 'govuk-exit-this-page'),
            (E.defaults = Object.freeze({
              i18n: {
                activated: 'Loading.',
          ...
          ;(T.moduleName = 'govuk-password-input'),
          ...
          class L extends d {
            ...
            syncConditionalRevealWithInputState(t) {
              ...
              if (
                null != s &&
                s.classList.contains('govuk-radios__conditional')
              ) {
                const e = t.checked
                t.setAttribute('aria-expanded', e.toString()),
          ...
          S.moduleName = 'govuk-service-navigation'
          class I extends d {
            constructor(e) {
              var i
              super(e)
              const n = this.$root.hash,
                o = null != (i = this.$root.getAttribute('href')) ? i : ''
              let r
              try {
                r = new window.URL(this.$root.href)
              } catch (t) {
                throw new l(
                  `Skip link: Target link (\`href="${o}"\`) is invalid`
                )
              }
              if (
              ...
              if (!c)
                throw new l({
                  component: I,
                  element: c,
                  identifier: `Target content (\`id="${a}"\`)`,
                })
              this.$root.addEventListener('click', () =>
                s(c, {
                  onBeforeFocus() {
                    c.classList.add('govuk-skip-link-focused-element')
                  },
                  onBlur() {
                    c.classList.remove('govuk-skip-link-focused-element')
                  },
                })
              )
            }
          }
          ;(I.elementType = HTMLAnchorElement),
            (I.moduleName = 'govuk-skip-link')
          class _ extends d {
            constructor(t) {
              super(t),
                (this.$tabs = void 0),
              ...
              if (!i.length)
                throw new l({
                  component: _,
                  identifier:
                    'List items (`<li class="govuk-tabs__list-item">`)',
                })
              ;(this.$tabList = s),
                (this.$tabListItems = i),
                this.setupResponsiveChecks()
            ...
            setup() {
              ...
              const e =
                null != (t = this.getTab(window.location.hash))
                  ? t
                  : this.$tabs[0]
              this.showTab(e),
            ...
            getPanel(e) {
              const s = t(e.href)
              return s ? this.$root.querySelector(`#${s}`) : null
            }
            showPanel(t) {
              const e = this.getPanel(t)
            ...
            constructor() {
              ...
              ;(this.zIndex = t.zIndex || 2),
                (this.backgroundColor =
                  t.backgroundColor || 'rgba(0, 0, 0, 0.5)'),
                (this.element = this.create())
            }
            create() {
              const t = document.createElement('div')
              return (
                t.classList.add('great-ds-overlay'),
          ...
          class B {
            ...
            init() {
              this.buttons.forEach((t) => {
                t.addEventListener('click', (e) => {
                  e.stopPropagation(), this.toggleReveal(t)
                })
              }),
            ...
            toggleReveal(t) {
              ...
              if (s) {
                const e = 'false' !== s.getAttribute('aria-hidden')
                s.setAttribute('aria-hidden', e ? 'false' : 'true'),
                  ...
                  t.hasAttribute('data-great-ds-reveal-modal') &&
                    (e ? this.overlay.show() : this.overlay.hide(),
                    (this.activeTarget = e ? s : null))
              }
            }
            handleOutsideClick(t) {
              t.target.closest('[data-great-ds-reveal-button]') ||
                document
                  .querySelectorAll(
                  ...
                  .forEach((e) => {
                    const s = e.getAttribute('aria-controls')
                    document.getElementById(s).contains(t.target) ||
                      e.contains(t.target) ||
                      this.toggleReveal(e)
                  })
            }
            handleEscapeKey(t) {
              'Escape' === t.key && this.hideAll()
            }
            handleFocusOut(t) {
              this.activeTarget &&
                !this.activeTarget.contains(t.relatedTarget) &&
                this.hideAll()
            }
            hideAll() {
              this.buttons.forEach((t) => {
          ...
          class H {
            ...
            get(t) {
              ...
              for (const t of s) {
                ...
                if (0 === s.indexOf(e))
                  return decodeURIComponent(s.substring(e.length))
              }
              return null
            }
            setPolicy() {
              ...
              this.set('cookies_policy', JSON.stringify(t))
            }
            getPolicy() {
              const t = this.get('cookies_policy')
              return t
                ? JSON.parse(t)
                : { essential: !0, settings: !1, usage: !1, campaigns: !1 }
            }
            setPreferences() {
              let t =
                !(arguments.length > 0 && void 0 !== arguments[0]) ||
                arguments[0]
              this.set('cookie_preferences_set', t.toString())
            }
            getPreferences() {
          ...
          'undefined' != typeof window &&
            ...
            (window.GreatDS.cookieManager = new H()))
          class O {
            constructor() {
              let t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : {}
              ;(this.cookieManager = new H(t.cookieDomain)),
                (this.modal = document.getElementById('cookie-modal')),
                (this.banner = document.getElementById('cookie-banner')),
                (this.modalTitle =
                  document.getElementById('cookie-modal-title')),
                (this.bannerTitle = document.getElementById(
                  'cookie-banner-title'
                )),
            ...
            init() {
              this.cookieManager.getPreferences() ||
                ...
                (this.showModal(), this.bindEvents())
            }
            bindEvents() {
              this.modal
            ...
            handleEscapeKey(t) {
              'Escape' !== t.key || this.modal.hidden || this.rejectAllCookies()
            }
            handleTabKey(t) {
              if ('Tab' === t.key) {
                const e = this.modal.querySelectorAll(this.focusableElements),
                  s = e[0],
                  i = e[e.length - 1]
                t.shiftKey
            ...
            showBanner() {
              ;(this.banner.hidden = !1), this.bannerTitle.focus()
            }
            hideBanner() {
            ...
            acceptAllCookies() {
              this.cookieManager.setPolicy(!0, !0, !0),
                this.cookieManager.setPreferences(),
                this.hideModal(),
                (this.statusElement.textContent =
                  this.statusElement.dataset.acceptedText),
                this.showBanner(),
                this.triggerAnalytics('cookies_policy_accept'),
                this.triggerAnalytics('gtm.dom')
            }
            rejectAllCookies() {
              this.cookieManager.setPolicy(!1, !1, !1),
                this.cookieManager.setPreferences(),
                this.hideModal(),
                (this.statusElement.textContent =
                  this.statusElement.dataset.rejectedText),
                this.showBanner()
            }
            triggerAnalytics(t) {
              window.analytics && window.analytics({ event: t })
            }
            destroy() {
              document.removeEventListener('keydown', this.handleEscapeKey),
          ...
          const q = async () => {
            ...
            j = (t) => {
              ...
              ;(t.target.innerHTML = `${e} Link copied`),
                t.target.setAttribute('iconPrefix', e)
            }
          !(function (t) {
            var e
            if (((t = void 0 !== t ? t : {}), !i()))
              return void (t.onError
                ? t.onError(new a(), { config: t })
                : console.log(new a()))
            const s = [
                [b, t.accordion],
                [w, t.button],
            ...
            s.forEach(([t, e]) => {
              !(function (t, e, s) {
                ...
                var r
                'object' == typeof s &&
                  ((o = null != (r = s.scope) ? r : o), (n = s.onError)),
                  'function' == typeof s && (n = s),
                  s instanceof HTMLElement && (o = s)
                const c = o.querySelectorAll(`[data-module="${t.moduleName}"]`)
                if (!i())
                  return (
                    n
                      ? n(new a(), { component: t, config: e })
                      : console.log(new a()),
                    []
                  )
                Array.from(c)
                  .map((s) => {
                    try {
                      return void 0 !== e ? new t(s, e) : new t(s)
                    } catch (i) {
                      return (
                        n
                          ? n(i, { element: s, component: t, config: e })
                          : console.log(i),
                        null
                      )
                    }
            ...
            (function () {
              let t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : {}
              const e = document.getElementById('cookie-modal'),
                s = document.getElementById('cookie-banner')
              e && s && new O(t)
            })(),
            (() => {
              const t = document.getElementById('copy-url-button')
              t &&
                (t.addEventListener('click', q), t.addEventListener('click', j))
            })()
        })()
      },
    },
  ...
  ;(s.n = (t) => {
    ...
    (great_design_system_scripts = {}.default)
})()
