      ...
      {sections.map(({ title, url, disabled }) => (
        <div className='c-1-3' key={url}>
          <div className='bg-white m-b-s section-list__item'>
            {disabled ?
              <div className='w-full link section-list__disabled' role='button' onClick={() => setModal(true)}>
                <div className='bg-blue-deep-20'>
                  <span className='section-list__coming bg-blue-deep-80 text-white body-m p-xxs'>Coming soon</span>
                  <img className='w-full p-h-s p-t-m p-b-s' src='/static/images/coming-soon.svg' alt={title} />
                </div>
