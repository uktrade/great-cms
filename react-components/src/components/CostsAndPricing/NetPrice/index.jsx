...
export const NetPrice = () => {
  return (
    <Input
      ...
      description='<h2 class="h-xs p-t-0 p-b-0">Your net price per unit in the Netherlands</h2><p class="m-t-xs">Deciding on what price your product will be sold for in retailers can be a difficult decision.</p><p class="m-b-0">You want to make sure you sell your product for more than it cost to make it, this way you make a profit on every unit sold.</p>'
    />
  )
}
