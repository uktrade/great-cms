  ...
  switch (action.type) {
    ...
    case INIT_COST_PRICING: {
      ...
      return {
        ...
        units_to_export: total_cost_and_price.units_to_export.value,
        export_units: total_cost_and_price.units_to_export.unit,
        export_end_month: total_cost_and_price.export_end ? total_cost_and_price.export_end.month : null,
        export_end_year: total_cost_and_price.export_end ? total_cost_and_price.export_end.year : null,
