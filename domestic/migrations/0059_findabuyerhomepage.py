# Generated by Django 4.2.7 on 2024-02-22 10:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0135_micrositepage_review_reminder_sent'),
        ('domestic', '0058_alter_articlepage_article_body'),
    ]

    operations = [
        migrations.CreateModel(
            name='FindABuyerHomePage',
            fields=[
                (
                    'page_ptr',
                ...
                ('hero_text_below_cta_logged_out', wagtail.fields.RichTextField(blank=True, null=True)),
                (
                    'hero_cta_logged_in',
                    wagtail.fields.StreamField(
                        [
                ...
                ('body_title', models.CharField(blank=True, max_length=255, verbose_name='Body title')),
            ...
            bases=(
                domestic.cms_panels.FindABuyerPagePanels,
                'wagtailcore.page',
