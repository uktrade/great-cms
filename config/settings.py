...
COPILOT_APPLICATION = env.str('COPILOT_APPLICATION', '')
COPILOT_ENVIRONMENT = env.str('COPILOT_ENVIRONMENT', '')

OTEL_PROPAGATORS = 'xray'
OTEL_PYTHON_ID_GENERATOR = 'xray'
OTEL_SERVICE_NAME = f'{COPILOT_APPLICATION}-{COPILOT_ENVIRONMENT}-web'
