...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            ROOT_DIR / 'node_modules' / '@uktrade' / 'great-design-system' / 'dist' / 'components' / 'tag-new',
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'core.context_processors.current_website_name',
...
BGS_ENROLMENT_WELCOME_TEMPLATE_ID = env.bgs_enrolment_welcome_template_id
...
BGS_CONTACT_FAS_COMPANY_NOTIFY_TEMPLATE_ID = env.bgs_contact_fas_company_notify_template_id
