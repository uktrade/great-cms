...
CONTACT_OFFICE_AGENT_NOTIFY_TEMPLATE_ID = env.str(
    'CONTACT_OFFICE_AGENT_NOTIFY_TEMPLATE_ID', '0492eb2b-7daf-4b37-99cd-be3abbb9eb32'
)
CONTACT_OFFICE_USER_NOTIFY_TEMPLATE_ID = env.str(
    'CONTACT_OFFICE_USER_NOTIFY_TEMPLATE_ID', '03c031e1-1ee5-43f9-8b24-f6e4cfd56cf1'
)
