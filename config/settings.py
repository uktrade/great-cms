...
FEATURE_INTERNATIONAL = env.bool('FEATURE_INTERNATIONAL', False)
...
FEATURE_FEEDBACK_BUTTON_EXPERIMENT = env.bool('FEATURE_FEEDBACK_BUTTON_EXPERIMENT', False)
...
EXPORT_ACADEMY_AUTOMATED_EVENT_COMPLETE_NOTIFICATION_TIME_DELAY_MINUTES = env.int(
    'EXPORT_ACADEMY_AUTOMATED_EVENT_COMPLETE_NOTIFICATION_TIME_DELAY_MINUTES', 15
)
