...
SESSION_ENGINE = env.str('SESSION_ENGINE', 'django.contrib.sessions.backends.signed_cookies')
...
EXPORT_ACADEMY_NOTIFY_BOOKING_TEMPLATE_ID = env.str(
    'EXPORT_ACADEMY_NOTIFY_BOOKING_TEMPLATE_ID', '68595b27-f604-47d3-859f-73d40d358e04'
)
