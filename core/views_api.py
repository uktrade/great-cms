...
class ComTradeDataView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        for country in countries_list:
            data = api_client.dataservices.get_last_year_import_data(
                country=country,
                commodity_code=commodity_code
            )
            import_data = data.json()['last_year_data']
            if import_data:
            ...
            data_from_uk = api_client.dataservices.get_last_year_import_data_from_uk(
                country=country,
                commodity_code=commodity_code
            )
            import_data_from_uk = data_from_uk.json()['last_year_data']
