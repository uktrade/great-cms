    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.core.fields.StreamField([('media', wagtail.core.blocks.StreamBlock([('image', core.blocks.ImageBlock()), ('video', wagtail.core.blocks.StructBlock([('video', core.blocks.MediaChooserBlock())]))], max_num=2, min_num=1)), ('text', wagtail.core.blocks.RichTextBlock(features=()))])),
