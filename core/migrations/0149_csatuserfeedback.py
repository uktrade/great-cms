# Generated by Django 4.2.11 on 2024-06-24 13:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0148_alter_alttextimage_alt_text'),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'user_journey',
                    models.CharField(
                        choices=[('ADD_PRODUCT', 'Add Product')], default='ADD_PRODUCT', max_length=255, null=True
                    ),
                ),
                (
                    'satisfaction_rating',
