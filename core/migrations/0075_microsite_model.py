        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        [
                            ('page', wagtail.blocks.PageChooserBlock(blank=True, null=True)),
                            (
                                'link',
                                wagtail.blocks.StructBlock(
                                    [
                                        ('title', wagtail.blocks.CharBlock(default='', form_classname='title')),
                                        ('full_url', wagtail.blocks.URLBlock(default='', form_classname='url')),
                                    ]
                                ),
                            ),
                        ],
