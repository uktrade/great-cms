...
EXPORT_SUPPORT_CATEGORIES_BGS = (
    ...
    ('/export-from-uk/support-topics/managing-business-risk-and-corruption', 'Managing business risk and corruption'),
)
...
class TemplateTagsEnum(Enum):
    ...
    GOV_NOTIFY_NEW_MEMBER_REGISTERED = 9
    CONTACT_INDUSTRY_AGENT = 10
    CAMPAIGN_MODERATORS_EMAIL = 11
    CAMPAIGN_SITE_REVIEW_REMINDER = 12
    CONTACT_ENQUIRIES_AGENT = 13
    CONTACT_EVENTS_AGENT = 14
    CONTACT_DSO_AGENT = 15
    ENROLMENT_WELCOME = 16
    CONTACT_FIND_SUPPLIER_OR_SPECIALIST_COMPANY = 17
...
TEMPLATE_TAGS = {
    True: {
        ...
        TemplateTagsEnum.GOV_NOTIFY_NEW_MEMBER_REGISTERED: settings.BGS_GOV_NOTIFY_NEW_MEMBER_REGISTERED_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_INDUSTRY_AGENT: settings.BGS_CONTACT_INDUSTRY_AGENT_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CAMPAIGN_MODERATORS_EMAIL: settings.BGS_CAMPAIGN_MODERATORS_EMAIL_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CAMPAIGN_SITE_REVIEW_REMINDER: settings.BGS_CAMPAIGN_SITE_REVIEW_REMINDER_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_ENQUIRIES_AGENT: settings.BGS_CONTACT_ENQUIRIES_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_EVENTS_AGENT: settings.BGS_CONTACT_EVENTS_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_DSO_AGENT: settings.BGS_CONTACT_DSO_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.ENROLMENT_WELCOME: settings.BGS_ENROLMENT_WELCOME_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_FIND_SUPPLIER_OR_SPECIALIST_COMPANY: settings.BGS_CONTACT_FAS_COMPANY_NOTIFY_TEMPLATE_ID,  # noqa E501
    },
    False: {
        ...
        TemplateTagsEnum.GOV_NOTIFY_NEW_MEMBER_REGISTERED: settings.GOV_NOTIFY_NEW_MEMBER_REGISTERED_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_INDUSTRY_AGENT: settings.CONTACT_INDUSTRY_AGENT_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CAMPAIGN_MODERATORS_EMAIL: settings.CAMPAIGN_MODERATORS_EMAIL_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CAMPAIGN_SITE_REVIEW_REMINDER: settings.CAMPAIGN_SITE_REVIEW_REMINDER_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_ENQUIRIES_AGENT: settings.CONTACT_ENQUIRIES_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_EVENTS_AGENT: settings.CONTACT_EVENTS_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_DSO_AGENT: settings.CONTACT_DSO_AGENT_NOTIFY_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.ENROLMENT_WELCOME: settings.ENROLMENT_WELCOME_TEMPLATE_ID,  # noqa E501
        TemplateTagsEnum.CONTACT_FIND_SUPPLIER_OR_SPECIALIST_COMPANY: settings.CONTACT_FAS_COMPANY_NOTIFY_TEMPLATE_ID,  # noqa E501
    },
}
