...
TEMPLATE_TAGS = {
    True: {},
    False: {
        TEMPLATE_TAG_ENUM.EXPORT_ACADEMY_NOTIFY_BOOKING.value: settings.EXPORT_ACADEMY_NOTIFY_BOOKING_TEMPLATE_ID,  # noqa E501
        TEMPLATE_TAG_ENUM.EXPORT_ACADEMY_NOTIFY_CANCELLATION.value: settings.EXPORT_ACADEMY_NOTIFY_CANCELLATION_TEMPLATE_ID,  # noqa E501
        TEMPLATE_TAG_ENUM.EXPORT_ACADEMY_NOTIFY_EVENT_REMINDER.value: settings.EXPORT_ACADEMY_NOTIFY_EVENT_REMINDER_TEMPLATE_ID,  # noqa E501
        TEMPLATE_TAG_ENUM.EXPORT_ACADEMY_NOTIFY_FOLLOW_UP.value: settings.EXPORT_ACADEMY_NOTIFY_FOLLOW_UP_TEMPLATE_ID,  # noqa E501
        TEMPLATE_TAG_ENUM.EXPORT_ACADEMY_NOTIFY_REGISTRATION.value: settings.EXPORT_ACADEMY_NOTIFY_REGISTRATION_TEMPLATE_ID,  # noqa E501
    },
}
