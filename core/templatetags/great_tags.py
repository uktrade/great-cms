...
@register.inclusion_tag('gds_tooling/cta_box.html')
def cta_box(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/message_box.html')
def message_box(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/message_box_with_icon.html')
...
@register.inclusion_tag('gds_tooling/hero.html')
def hero(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/card.html')
def card(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/image_with_caption.html')
def image_with_caption(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/cta_card.html')
def cta_card(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/cta_link.html')
def cta_link(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/statistics_card_grid.html')
def statistics_card_grid(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/hero_with_cta.html')
def hero_with_cta(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/informative_banner.html')
def informative_banner(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/case_study.html')
...
@register.inclusion_tag('gds_tooling/header_footer/invest_header.html', takes_context=True)
...
@register.inclusion_tag('gds_tooling/search-page-selected-filters.html')
def search_page_selected_filters(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/search-page-expandable-options.html')
def search_page_expandable_options(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/full-width-image-with-list-and-media.html')
def feature_list(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/key_facts.html')
def key_facts(**kwargs):
    return kwargs


@register.inclusion_tag('gds_tooling/accordion_list.html')
