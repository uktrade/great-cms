...
from wagtail.admin.mail import (
    GroupApprovalTaskStateSubmissionEmailNotifier as dis,
    WorkflowStateSubmissionEmailNotifier as dis2,
)
...
def register_signal_handlers():
    task_submission_email_notifier = dis()
    workflow_submission_email_notifier = dis2()
