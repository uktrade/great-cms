...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--environment_a', required=False, help='The first environment to compare (against environment_a).'
        )
        parser.add_argument(
            '--environment_b', required=False, help='The second environment to compare (against environment_b).'
        )
